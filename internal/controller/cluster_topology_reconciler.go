...
func topologyObservationInput(observed observedCluster, cluster *mysqlv1alpha1.Cluster, gr *mysqlv1alpha1.GroupReplicationStatus, priorDiverged []string) topology.ObservationInput {
