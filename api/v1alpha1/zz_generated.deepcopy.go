...
func (in *BackupConfiguration) DeepCopyInto(out *BackupConfiguration) {
	*out = *in
	...
	if in.LogicalOptions != nil {
		in, out := &in.LogicalOptions, &out.LogicalOptions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapImport) DeepCopyInto(out *BootstrapImport) {
	*out = *in
	if in.Backup != nil {
	...
	if in.PostImportSQL != nil {
		in, out := &in.PostImportSQL, &out.PostImportSQL
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapImport.
func (in *BootstrapImport) DeepCopy() *BootstrapImport {
	if in == nil {
		return nil
	}
	out := new(BootstrapImport)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterStatus) DeepCopyInto(out *ClusterStatus) {
	*out = *in
	...
	if in.PrimaryFailingSince != nil {
		in, out := &in.PrimaryFailingSince, &out.PrimaryFailingSince
		*out = (*in).DeepCopy()
	}
	if in.PrimaryHealthySince != nil {
		in, out := &in.PrimaryHealthySince, &out.PrimaryHealthySince
		*out = (*in).DeepCopy()
	}
	if in.LastFailoverTimestamp != nil {
		in, out := &in.LastFailoverTimestamp, &out.LastFailoverTimestamp
		*out = (*in).DeepCopy()
	}
	...
	if in.ReplicationLagByInstance != nil {
		in, out := &in.ReplicationLagByInstance, &out.ReplicationLagByInstance
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ReplicationLagUpdatedAt != nil {
		in, out := &in.ReplicationLagUpdatedAt, &out.ReplicationLagUpdatedAt
		*out = (*in).DeepCopy()
	}
...
func (in *ContinuousArchivingConfiguration) DeepCopyInto(out *ContinuousArchivingConfiguration) {
	*out = *in
	if in.PurgeAfterArchive != nil {
		in, out := &in.PurgeAfterArchive, &out.PurgeAfterArchive
		*out = new(bool)
		**out = **in
	}
}
...
func (in *FailoverPolicy) DeepCopyInto(out *FailoverPolicy) {
	*out = *in
	if in.MaxTransactionsBehind != nil {
		in, out := &in.MaxTransactionsBehind, &out.MaxTransactionsBehind
		*out = new(int64)
		**out = **in
	}
	...
	if in.PreferredPrimary != nil {
		in, out := &in.PreferredPrimary, &out.PreferredPrimary
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicationHeartbeat) DeepCopyInto(out *ReplicationHeartbeat) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicationHeartbeat.
func (in *ReplicationHeartbeat) DeepCopy() *ReplicationHeartbeat {
	if in == nil {
		return nil
	}
	out := new(ReplicationHeartbeat)
