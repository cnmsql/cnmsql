...
// streaming clones: the flag must default to empty so BackupStream falls back to
// the engine's binary (mariabackup on MariaDB) instead of pinning to xtrabackup.
